        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center gap-1">
              ...
              <Button
                onClick={() => window.open("https://wa.me/56940349957?text=Hola%20Limpieza24%2F7%2C%20quiero%20cotizar%20un%20servicio%20de%20limpieza", "_blank")}
                ...
                >
                  ...
                  <CardContent className="px-6 pb-6">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        window.open(
                          `https://wa.me/56940349957?text=Hola%20Limpieza24%2F7%2C%20quiero%20cotizar%20${encodeURIComponent(service.title)}`,
                          "_blank"
                        )
                      }
                    >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              ...
              <p className="text-lg text-gray-600 max-w-xl mx-auto">
                Más de 2.000 hogares en Santiago confían en Limpieza24/7.
              </p>
            </div>
      ...
      <footer className="bg-gray-900 text-gray-300 pb-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-500">
            <p>© 2024 Limpieza24/7. Todos los derechos reservados.</p>
