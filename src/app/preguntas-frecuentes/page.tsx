        ...
        <section className="py-16 bg-emerald-50/50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-base px-8" onClick={() => window.open("https://wa.me/56940349957?text=Hola%20Limpieza24%2F7%2C%20tengo%20una%20consulta%20sobre%20sus%20servicios", "_blank")}>
