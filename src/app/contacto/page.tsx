      ...
      <main className="flex-1">
        ...
        <section className="py-16 bg-emerald-50/50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <Button size="lg" className="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-base px-10" onClick={() => window.open("https://wa.me/56940349957?text=Hola%20Limpieza24%2F7%2C%20quiero%20cotizar%20un%20servicio%20de%20limpieza", "_blank")}>
